...
export function SettingsDialog({
    ...
    const handleToggleActionEnabled = (id: string) => {
        if (!actions) return;
        const updatedActions = actions.map(a => (a.id === id ? { ...a, enabled: !a.enabled } : a));
        handleActionsChange(updatedActions);
                            ...
                            <div style={{ marginBottom: '16px' }}>
                                ...
                                <div style={{ marginBottom: '16px' }}>
                                    {actions && actions.length > 0 ? (
                                                ...
                                                <div className='llm-config-header'>
                                                    <div className='llm-config-info'>
                                                        <Switch
                                                            ...
                                                            onChange={() =>
                                                                handleToggleActionEnabled(action.id)
                                                            }
                                                        />
                                                        <div>
                                                            <div style={{ fontSize: '0.875rem' }}>
                                        ...
                                        >
                                            No actions configured yet. Click "Add New Action" to
                                            create one.
                                        </div>
                                    )}
                                </div>
                                ...
                                {editingAction &&
                                    (!actions || !actions.find(a => a.id === editingAction.id)) && (
                                        <div className='edit-form'>
                                            <h3 className='edit-form-title'>Add Action</h3>
                        ...
                        <div style={{ padding: '16px 24px' }}>
                            <div className='form-field'>
                                ...
                                >
                                    ...
                                    <Select.Option value='high-contrast-light'>
                                        High Contrast Light
                                    </Select.Option>
                                    <Select.Option value='high-contrast-dark'>
                                        High Contrast Dark
                                    </Select.Option>
                                </Select>
                                <p
