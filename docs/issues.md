# BYOA (Build Your Own Assistant) — Issue Tracker Bridge (GitHub Issues)

> This project uses **GitHub Issues** at [shmmsra/byoa](https://github.com/shmmsra/byoa/issues) as the canonical issue tracker.
>
...
Then mark it in progress by adding a label:
...
```
feat(scope): add retry logic for upstream timeouts
...
|-------|-------|----------|--------|
| — | *(none yet — file issues on GitHub as work is planned)* | — | — |
