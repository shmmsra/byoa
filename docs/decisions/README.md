...
This directory holds the architectural decisions for BYOA (Build Your Own Assistant). Every significant design choice that another agent might wonder about — *"why is this done this way?"* — should be recorded here.
