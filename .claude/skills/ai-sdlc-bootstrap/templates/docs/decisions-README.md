...
This directory holds the architectural decisions for {{PROJECT_NAME}}. Every significant design choice that another agent might wonder about — *"why is this done this way?"* — should be recorded here.
